...
The file `build/html5-skin.min.js` from https://github.com/ooyala/html5-skin/tree/4.2.2 after building via `gulp build`
As of March 21, 2016 v4.2.2 is not hosted via CDN.
...
OO.plugin("Html5Skin", function (OO, _, $, W) {
  ...
  if (OO.publicApi && OO.publicApi.VERSION) {
    ...
    OO.publicApi.VERSION.skin_version = "0857a4afcfadf0e9b16344a58d61eeb800251720";
  }
...
},{"../components/closeButton":4,"../components/icon":10,"../components/videoQualityPanel":18,"../constants/constants":20,"../mixins/accessibilityMixin":22,"react":197,"react-scrollbar/dist/no-css":68}],37:[function(require,module,exports){
/*!
